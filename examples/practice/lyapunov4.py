from numpy import eye, mat, log
from scipy.linalg import orth as ortho
from numpy.linalg import norm

def lorenz_spectra(F, T, dt):
    ...
    t, x = ode45(F, timerange(0, 1, 10), (x1, x2, x3))
    n = length(t)
    ...
    t, x = ode45(F, timerange(0, dt, T), (x1, x2, x3))
    e1 = 0
    e2 = 0
    e3 = 0
